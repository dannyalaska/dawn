...
SAMPLE_SUPPORT_TICKETS = {
    ...
    "data": [
        ["TK-001", "2024-01-15 09:30", "Alex Chen", "Alex Chen", "Closed", "High", "Account", 2.5, "Acme Corp", "Login not working"],
        ["TK-002", "2024-01-15 10:15", "Priya Sharma", "Priya Sharma", "Closed", "Medium", "Billing", 4.2, "Beta Inc", "Invoice discrepancy"],
        ["TK-003", "2024-01-15 11:00", "Alex Chen", "Alex Chen", "Closed", "High", "Technical", 1.8, "Gamma Ltd", "API timeout issue"],
        ["TK-004", "2024-01-15 14:30", "Marcus Johnson", "Marcus Johnson", "Closed", "Low", "General", 6.5, "Delta Co", "Feature request"],
        ["TK-005", "2024-01-15 15:45", "Priya Sharma", "Priya Sharma", "Closed", "High", "Account", 3.2, "Epsilon Corp", "Payment method declined"],
        ["TK-006", "2024-01-16 08:00", "Alex Chen", "Alex Chen", "Closed", "Medium", "Technical", 2.1, "Zeta Systems", "Dashboard loading slow"],
        ["TK-007", "2024-01-16 09:30", "Sarah Williams", "Sarah Williams", "Closed", "High", "Billing", 5.5, "Eta Industries", "Multiple charges"],
        ["TK-008", "2024-01-16 11:00", "Marcus Johnson", "Marcus Johnson", "Closed", "Low", "General", 7.2, "Theta Corp", "Documentation question"],
        ["TK-009", "2024-01-16 13:15", "Priya Sharma", "Priya Sharma", "Closed", "High", "Account", 2.8, "Iota Ltd", "2FA setup issue"],
        ["TK-010", "2024-01-16 16:00", "Alex Chen", "Alex Chen", "Closed", "Medium", "Technical", 3.5, "Kappa Inc", "Export data problem"],
        ["TK-011", "2024-01-17 09:00", "Sarah Williams", "Sarah Williams", "Closed", "High", "Account", 4.1, "Lambda Co", "Subscription cancellation"],
        ["TK-012", "2024-01-17 10:30", "Priya Sharma", "Priya Sharma", "Closed", "Medium", "Billing", 3.7, "Mu Systems", "Invoice customization"],
    ],
}
